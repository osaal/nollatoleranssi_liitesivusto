...
*Tämä blogikirjoitus julkaistaan Pelastusopiston blogissa 13.11.2024.* *Osion analyysit ovat toistettavissa Tietoarkistoon arkistoidulla aineistokopiolla. Ennen toistoa tulee suorittaa [luvussa -@sec-datatarkistus] esitetyt aineistopoistot.*

------------------------------------------------------------------------

*Pelastusopiston toteuttama ja Palosuojelurahaston rahoittama Nollatoleranssi-hanke on selvittänyt epäasiallisen ja väkivaltaisen kohtelun esiintyvyyttä, vaikutuksia ja toimenpiteitä pelastusalalla. Tämä blogi on osa neljän julkaisun blogisarjaa, jossa käsitellään valtakunnallisen kyselytutkimuksen tuloksia. Seuraava blogi julkaistaan 16. joulukuuta 2024.*
...
Koetun epäasiallisen ja väkivaltaisen kohtelun määrä on yhteydessä vaikutusten vakavuuteen, mutta yhteydet eroavat tekoympäristön mukaan. Organisaatiosisäisen kohtelun osalta jokainen lisäpiste 50 pisteen kohtelumittarilla laskee fyysisiä vaikutuksia -0,9 pistettä mutta nostaa psyykkisiä vaikutuksia 0,8 pistettä ja ammatillisia vaikutuksia jopa 1,1 pistettä. Fyysisten vaikutusten lasku voi johtua sairaslomista, jolloin henkilö ei yksinkertaisesti voi kokea enempiä vaikutuksia työpaikkaväkivallan takia. Organisaation ulkopuolinen, asiakkailta tai sidosryhmiltä tuleva väkivalta on yhteydessä vain fyysisiin vaikutuksiin: jokainen lisäpiste nostaa fyysisiä vaikutuksia jopa 2,8 pistettä.

Yhteydet ovat suhteellisen vahvoja. Tilastolliset mallit selittävät yli 30 prosenttia kaikesta vaihtelusta kohtelumittarilla ja vaikutuksissa, eli iso osa koetuista vaikutuksista voi johtua vain koetun kohtelun määrästä, eikä muista tekijöistä.

## Työuupumus seuraa koetun kohtelun määrää

Epäasiallisen ja väkivaltaisen kohtelun määrät korreloivat positiivisesti työuupumusmittariston pisteiden kanssa riippumatta tekokontekstista (@fig-blogi2-04-uupumusXkohtelu). Korrelaatio on kuitenkin vahvempi organisaatiosisäisen kohtelun osalta (r = 0,34) kuin ulkoisen kohtelun osalta (r = 0,19). Sisäisen sekä ulkoisen kohtelun määrät selittävät 11 ja 4 prosenttia työuupumusmittarin vaihtelusta. Vaikka asteet eivät itsessään ole suuria, ihmistieteissä yleisesti ei löydy yksittäisiä selittäviä tekijöitä ilmiöille, jolloin kaltaiset määrät voidaan nähdä merkittävinä.
...
Jokainen lisäpiste organisaatiosisäistä kohtelumäärää nostaa vastaajan todennäköisyyttä olla työuupunut `r round(exp(summary(uupumus.log.sisa)$coefficients["EVK_sisä_koettu",1]), digits = 2)`-kertaisesti. Organisaatioulkoinen kohtelumäärä ei kuitenkaan ole yhteydessä työuupumuksen todennäköisyyteen.

Todennäköisesti työuupunut vastaaja on kohdannut jopa kuusi kertaa enemmän organisaatiosisäistä epäasiallista ja väkivaltaista kohtelua (@fig-blogi2-06-toduup). Organisaatioulkoisen kohtelun kohdalla ero ei ole merkitsevä uupumustilan mukaan.
...
Kaikista vastaajista noin 20 prosenttia on harkinneet jotain muutosta. Joka kymmenes on muuttanut tai muuttamassa tehtävänkuvaansa. 2-4 prosenttia on vaihtamassa organisaatiotaan tai lähtemässä alalta.

Mitä enemmän vastaaja oli kohdannut epäasiallista tai väkivaltaista kohtelua, sitä useamman muutosaikeen hän oli ilmoittanut kyselyssä (@fig-blogi2-07-muutosaieXkohtelu). Yhteys on keskivahva organisaatiosisäisen kohtelumäärän ja muutosaikeiden välillä (r = 0,41), mutta pieni organisaatioulkoisen kohtelun osalta (r = 0,24). Sisäisen sekä ulkoisen kohtelun määrät selittävät 17 ja 6 prosenttia muutosaikeiden vaihtelusta, eli hieman enemmän kuin työuupumuksen osalta.
...
Jokainen lisäpiste organisaatiosisäistä kohtelun määrää nostaa vastaajan todennäköisyyttä valita melkein minkä tahansa muutosaikeen. Tehtävänkuvan muutosten toteuttaminen ei ole tilastollisessa yhteydessä kohtelun määrään. Todennäköisyydet nousevat noin 1,1-1,2-kertaisesti jokaisella lisäpisteellä.

Organisaatioulkoinen kohtelu ei ole yhtä selkeässä yhteydessä muutosaikeiden todennäköisyydelle. Mitä enemmän vastaaja oli kohdannut epäasiallista ja väkivaltaista kohtelua organisaation ulkopuolelta, sitä enemmän hän oli harkinnut jotain muutoksista, mutta toteuttamisen ja kohtelun välillä ei nähty tilastollista yhteyttä. Todennäköisyyksien nousut ovat myös organisaatiosisäisen kohtelun yhteyksiä puolet pienempiä, vain noin 1,05-kertaisia.
