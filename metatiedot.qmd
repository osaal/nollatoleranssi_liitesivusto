...
Tässä osiossa käymme läpi kyselytutkimuksen meta- ja taustatietojen tulokset. Tiedot pohjautuvat anonymisoituun datatiedostoon, josta on poistettu epäilyttävät vastaajat. Osion voi toistaa lataamalla Tietoarkistossa oleva datakopio ja ensin suorittamalla [luvun -@sec-datatarkistus] koodit.
...
## Epäilyttävät vastaukset {#sec-metatiedot-epailyttavat}

Anonymisoinnin jälkeen tarkistimme kaikilta vastaajilta epäilyttävät tiedot neljältä muuttujaryhmältä (ks. @sec-datatarkistus). Tarkistuksen pohjalta poistimme 65 vastaajaa. Jäljelle jäi siten 960 vastaajaa.
