...
Nollatoleranssi-hankkeen kolmannessa blogissa käsittelemme epäasiallisen ja väkivaltaisen kohteluun liittyviä ilmoitus- ja raportointijärjestelmiä. Missä määrin järjestelmiä on otettu käyttöön, ja onko niihin saatavilla koulutusta? Millaiseksi järjestelmät mielletään?
...
Ulkoisesti koettu epäasiallinen ja väkivaltainen kohtelu on yhteydessä järjestelmien koettuun olemassaoloon, mutta sisäinen ei ole (@fig-blogi3-03-jarjestelmaXevk). On oletettavaa, että yksilö, joka kokee epäasiallista ja väkivaltaista kohtelua, on myös tietoisempi organisaationsa tarjoamista työkaluista. Siksi onkin yllättävää, ettei yhteyttä nähdä sisäisen kohtelun kokemusten osalta: vastaajat ovat yhtä (epä)tietoisia järjestelmän olemassaolosta riippumatta siitä, miten paljon työpaikkasisäistä epäasiallisuutta ja väkivaltaa he ovat kohdanneet. On mahdollista, että järjestelmiä sisäisten ongelmien raportoimiselle ei käytännössä ole käytössä, tai ettei henkilöstö tiedä järjestelmistä tarpeeksi käyttääkseen niitä.
...
Yleinen syy raportoimatta jättämiseksi on osaamisen puutteet ilmoitusjärjestelmien käytössä: jos järjestelmää ei osata käyttää tai ei löydetä organisaation tiedoista, epäasiallisia ja väkivaltaisia kokemuksia ei myöskään raportoida. Siksi onkin huolestuttavaa, että vastaajamme eivät usein näytä käyneensä koulutusta tai tietävänsä sellaisen olemassaolosta. Raportointiasteen nostamisen kannalta organisaatioiden olisi tärkeä tuoda järjestelmiä ja niiden käyttöä esille. Jos koulutusta ei ole olemassa, sellaisen järjestäminen on suotavaa.

## Ilmoitusjärjestelmiin kohdistuvat asenteet huononevat, mitä enemmän kohtelua vastaaja on kohdannut

Kysyimme kaikilta vastaajilta heidän mielipidettään 18 eri väittämään ilmoitusjärjestelmistä ja raportoinnista. Näistä 14 väittämää koskivat raportointiprosesseja, ja ne mittasivat kahta eri asennerakennetta: vastaajan kokemaa suhdetta ilmoittamisen hyödyn ja henkilöllisten resurssien välillä, sekä vastaajan pelko negatiivisista seuraamuksista (@tbl-blogi3-asenteet). Rakensimme kahdet mittarit, joilla suurempi arvo tarkoittaa enemmän negatiivisuutta (heikompi koettu hyöty-panos-suhde tai suurempi pelko negatiivisista seuraamuksista).
