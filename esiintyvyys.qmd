...
# Sisäisen kohtelun kymmenen yleisintä kokemusmuotoa (% kohtelumuodon havanneista vastaajista)
yleisimmat.sisa |>
  ggplot(aes(
    x = prop,
    y = reorder(variable, prop),
  ...
  labs(
    x = "Suhde kohtelun ylämuodon havanneista vastaajista (%)",
    fill = "Ylämuoto"
  ) + 
  theme(axis.title.y = element_blank()) + 
  geom_label(
...
# Ulkoisen kohtelun kymmenen yleisintä kokemusmuotoa (% kohtelumuodon havanneista vastaajista)
yleisimmat.ulko |>
  ggplot(aes(
    x = prop,
    y = reorder(variable, prop),
