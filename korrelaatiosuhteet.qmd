...
## Toimintaohjelman käyttöönoton suhde kohteluun
...
## Toimintaohjelman käyttöönoton suhde kohtelun vakavuuteen

```{r}
#| label: fig-korrelaatiosuhteet-tayvkayttoonottovakavuus
#| fig-cap: "Toimintaohjelman käyttöönoton korrelaatio vaikutusten pitkäkestoisuuden kanssa"
#| layout-nrow: 1
#| fig-subcap: 
#| -  "Sisäinen"
#| -  "Ulkoinen"
