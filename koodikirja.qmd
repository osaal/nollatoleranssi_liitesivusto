...
Tässä osiossa rakennamme koodikirjan anonymisoidulle aineistolle. Koodikirja tallennetaan `output`-kansioon `csv`-muodossa.
...
Valmistelemme ensin kaksiulotteisen datarakenteen, johon tallennetaan kaikki muuttujakohtaiset tiedot. Jokaiselle muuttujalle tulee oma rivi. Ensimmäiseen sarakkeeseen lisätään muuttujien aineistossa esiintyvät nimet.
