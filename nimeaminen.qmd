...
Seuraavaksi muuttujat nimetään hankkeessa vakiintuneiden lyhenteiden mukaisesti. Tässä listataan nimeämiset lomakkeen (ja täten datatiedoston) järjestyksessä.
...
1.  **Linkkiversio** jätetään sellaiseksi.
2.  **Kieliversio** jätetään sellaiseksi.
...
## Ilmoitusjärjestelmät ja työolot
