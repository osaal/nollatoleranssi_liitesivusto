...
Alkuperäiset nimet löytyvät `csv`-tiedostosta tämän verkkosivun lähdekoodissa, kansiossa `data > muuttujiennimet.csv`.

Alkuperäistä dataa ei ole saatavilla tietosuojan takia.
...
#| code-summary: "Aineiston avaaminen ja uudelleennimeäminen"
...
## Aineiston tallennus {#sec-nimeaminen-tallennus}

```{r}
#| label: nimeaminen-02-tallennus
#| code-summary: "Uudelleennimetyn aineiston tallentaminen"
