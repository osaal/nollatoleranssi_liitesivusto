...
("polis*" OR "ordningsv?kt*" OR "försvars*" OR "soldat*" OR "gränsbevak*" OR "gränskontroll*") AND (diskriminer* OR trakasse* OR påtryck* OR våld* OR osaklig* OR opasslig* OR jämlik* OR jämställd*) AND PEER(yes) AND PUBDATE(20100101-20230930)

# Emme tällä hetkellä pysty toistamaan tätä hakua. Selvitämme virhettä ja korjaamme kirjauksen.
```
...
https://api.openalex.org/works?search=(polis%20OR%20ordningsv%20OR%20f%C3%B6rsvars%20OR%20soldat%20OR%20gr%C3%A4nsbevak%20OR%20gr%C3%A4nskontroll)%20AND%20(diskriminer%20OR%20trakasse%20ORp%C3%A5tryck%20OR%20v%C3%A5ld%20OR%20osaklig%20OR%20opasslig%20ORj%C3%A4mlik%20ORj%C3%A4mst%C3%A4lld)%20AND%20(finland%20OR%20finsk)&filter=from_publication_date:2010-01-01,to_publication_date:2023-09-30,type_crossref:journal-article|monograph|report&per_page=200&select=title,publication_year,doi&page=1
...
https://api.openalex.org/works?filter=title_and_abstract.search:police%20OR%20guard%20OR%20defence%20contractor%20OR%20steward%20OR%20soldier%20OR%20military%20personne)%20AND%20(discriminat%20OR%20harass%20OR%20pressure%20OR%20violen%20OR%20improper%20behavior%20OR%20equal%20OR%20equit)%20AND%20(finland%20OR%20finnish),from_publication_date:2010-01-01,to_publication_date:2023-09-30,type_crossref:journal-article|monograph|report&per_page=200&select=title,publication_year,doi&page=1
